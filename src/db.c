...
/* List of built-in attributes: you MUST make sure the names are lowercase */
ATTR attr[] =
{
{"Aahear",	A_AAHEAR,	AF_NOPROG,			NULL},
{"Aclone",	A_ACLONE,	AF_NOPROG,			NULL},
{"Aconnect",	A_ACONNECT,	AF_NOPROG,			NULL},
{"Adesc",	A_ADESC,	AF_NOPROG,			NULL},
{"Adfail",	A_ADFAIL,	AF_NOPROG,			NULL},
{"Adisconnect",	A_ADISCONNECT,	AF_NOPROG,			NULL},
{"Adrop",	A_ADROP,	AF_NOPROG,			NULL},
{"Aefail",	A_AEFAIL,	AF_NOPROG,			NULL},
{"Aenter",	A_AENTER,	AF_NOPROG,			NULL},
{"Afail",	A_AFAIL,	AF_NOPROG,			NULL},
{"Agfail",	A_AGFAIL,	AF_NOPROG,			NULL},
{"Ahear",	A_AHEAR,	AF_NOPROG,			NULL},
{"Akill",	A_AKILL,	AF_NOPROG,			NULL},
{"Aleave",	A_ALEAVE,	AF_NOPROG,			NULL},
{"Alfail",	A_ALFAIL,	AF_NOPROG,			NULL},
{"Alias",	A_ALIAS,	AF_NOPROG|AF_NOCMD|AF_NOCLONE|AF_PRIVATE|AF_CONST,
								NULL},
{"Allowance",	A_ALLOWANCE,	AF_MDARK|AF_NOPROG|AF_WIZARD,	NULL},
{"Amail",	A_AMAIL,	AF_NOPROG,			NULL},
{"Amhear",	A_AMHEAR,	AF_NOPROG,			NULL},
{"Amove",	A_AMOVE,	AF_NOPROG,			NULL},
{"Apay",	A_APAY,		AF_NOPROG,			NULL},
{"Arfail",	A_ARFAIL,	AF_NOPROG,			NULL},
{"Asucc",	A_ASUCC,	AF_NOPROG,			NULL},
{"Atfail",	A_ATFAIL,	AF_NOPROG,			NULL},
{"Atport",	A_ATPORT,	AF_NOPROG,			NULL},
{"Atofail",	A_ATOFAIL,	AF_NOPROG,			NULL},
{"Aufail",	A_AUFAIL,	AF_NOPROG,			NULL},
{"Ause",	A_AUSE,		AF_NOPROG,			NULL},
{"Away",	A_AWAY,		AF_NOPROG,			NULL},
...
{"Conformat",	A_LCON_FMT,	AF_NOPROG,			NULL},
...
{"Lastsite",	A_LASTSITE,	AF_NOPROG|AF_NOCMD|AF_NOCLONE|AF_GOD,
								NULL},
{"Leave",	A_LEAVE,	AF_NOPROG,			NULL},
{"Leavelock",	A_LLEAVE,	AF_NOPROG|AF_NOCMD|AF_IS_LOCK,	NULL},
{"Lfail",	A_LFAIL,	AF_NOPROG,			NULL},
...
{"Mailsub",	A_MAILSUB,	AF_DARK|AF_NOPROG|AF_NOCMD|AF_INTERNAL,
								NULL},
{"Mailsucc",	A_MAIL,		AF_NOPROG,			NULL},
{"Mailto",	A_MAILTO,	AF_DARK|AF_NOPROG|AF_NOCMD|AF_INTERNAL,
								NULL},
{"Move",	A_MOVE,		AF_NOPROG,			NULL},
{"Name",	A_NAME,		AF_DARK|AF_NOPROG|AF_NOCMD|AF_INTERNAL,
								NULL},
{"Nameformat",	A_NAME_FMT,	AF_NOPROG,			NULL},
{"Newobjs",	A_NEWOBJS,	AF_MDARK|AF_NOPROG|AF_GOD|AF_NOCMD|AF_NOCLONE,
								NULL},
{"Odesc",	A_ODESC,	AF_NOPROG,			NULL},
{"Odfail",	A_ODFAIL,	AF_NOPROG,			NULL},
{"Odrop",	A_ODROP,	AF_NOPROG,			NULL},
{"Oefail",	A_OEFAIL,	AF_NOPROG,			NULL},
{"Oenter",	A_OENTER,	AF_NOPROG,			NULL},
{"Ofail",	A_OFAIL,	AF_NOPROG,			NULL},
{"Ogfail",	A_OGFAIL,	AF_NOPROG,			NULL},
{"Okill",	A_OKILL,	AF_NOPROG,			NULL},
{"Oleave",	A_OLEAVE,	AF_NOPROG,			NULL},
{"Olfail",	A_OLFAIL,	AF_NOPROG,			NULL},
{"Omove",	A_OMOVE,	AF_NOPROG,			NULL},
{"Opay",	A_OPAY,		AF_NOPROG,			NULL},
{"Orfail",	A_ORFAIL,	AF_NOPROG,			NULL},
{"Osucc",	A_OSUCC,	AF_NOPROG,			NULL},
{"Otfail",	A_OTFAIL,	AF_NOPROG,			NULL},
{"Otport",	A_OTPORT,	AF_NOPROG,			NULL},
{"Otofail",	A_OTOFAIL,	AF_NOPROG,			NULL},
{"Oufail",	A_OUFAIL,	AF_NOPROG,			NULL},
{"Ouse",	A_OUSE,		AF_NOPROG,			NULL},
{"Oxenter",	A_OXENTER,	AF_NOPROG,			NULL},
{"Oxleave",	A_OXLEAVE,	AF_NOPROG,			NULL},
{"Oxtport",	A_OXTPORT,	AF_NOPROG,			NULL},
...
{"Succ",	A_SUCC,		AF_NOPROG,			NULL},
{"Teloutlock",	A_LTELOUT,	AF_NOPROG|AF_NOCMD|AF_IS_LOCK,	NULL},
{"Tfail",	A_TFAIL,	AF_NOPROG,			NULL},
{"Timeout",	A_TIMEOUT,	AF_MDARK|AF_NOPROG|AF_WIZARD,	NULL},
{"Tport",	A_TPORT,	AF_NOPROG,			NULL},
{"Tportlock",	A_LTPORT,	AF_NOPROG|AF_NOCMD|AF_IS_LOCK,	NULL},
{"Ttofail",	A_TOFAIL,	AF_NOPROG,			NULL},
{"Ufail",	A_UFAIL,	AF_NOPROG,			NULL},
{"Use",		A_USE,		AF_NOPROG,			NULL},
...
{"Htdesc",	A_HTDESC,	AF_VISUAL|AF_NOPROG,		NULL},
