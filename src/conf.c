...
{(char *)"comsys_database",
	cf_string,	CA_DISABLED,	(int *)mudconf.comsys_db,	PBUF_SIZE},
...
{(char *)"compress_program",
	cf_string,	CA_DISABLED,	(int *)mudconf.compress,	PBUF_SIZE},
{(char *)"compression",
...
{(char *)"connect_file",
	cf_string,	CA_DISABLED,	(int *)mudconf.conn_file,	SBUF_SIZE},
{(char *)"connect_reg_file",
	cf_string,	CA_DISABLED,	(int *)mudconf.creg_file,	SBUF_SIZE},
{(char *)"crash_database",
	cf_string,	CA_DISABLED,	(int *)mudconf.crashdb,		PBUF_SIZE},
...
{(char *)"down_file",
	cf_string,	CA_DISABLED,	(int *)mudconf.down_file,	SBUF_SIZE},
...
{(char *)"fixed_home_message",
	cf_string,	CA_DISABLED,	(int *)mudconf.fixed_home_msg,	PBUF_SIZE},
{(char *)"fixed_tel_message",
	cf_string,	CA_DISABLED,	(int *)mudconf.fixed_tel_msg,	PBUF_SIZE},
...
{(char *)"game_log",
     	cf_string,	CA_DISABLED,	(int *)mudconf.mudlogname,	PBUF_SIZE},
{(char *)"gdbm_database",
...
{(char *)"guest_prefix",
        cf_string,      CA_DISABLED,    (int *)mudconf.guest_prefix,    SBUF_SIZE},
{(char *)"number_guests",
...
{(char *)"mail_database",
	cf_string,	CA_DISABLED,	(int *)mudconf.mail_db,		PBUF_SIZE},
...
{(char *)"motd_file",
	cf_string,	CA_DISABLED,	(int *)mudconf.motd_file,	SBUF_SIZE},
{(char *)"motd_message",
...
{(char *)"output_database",
	cf_string,	CA_DISABLED,	(int *)mudconf.outdb,		PBUF_SIZE},
{(char *)"output_limit",
...
{(char *)"quit_file",
	cf_string,	CA_DISABLED,	(int *)mudconf.quit_file,	SBUF_SIZE},
{(char *)"quotas",
...
{(char *)"register_create_file",
	cf_string,	CA_DISABLED,	(int *)mudconf.regf_file,	SBUF_SIZE},
{(char *)"register_site",
	cf_site,	CA_GOD,		(int *)&mudstate.access_list,
	H_REGISTRATION},
